...
class _HospitalityEventViewState extends State<HospitalityEventView> {
  ...
  Future<void> fetchEventInfo() async {
    ...
    //for each timestamp, get the data
  ...
  Future<void> fetchEventData(String timeStamp) async {
    ...
    //grab all info except volunteer count
    ...
    //count volunteers who signed up
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                      "Volunteers: " + eventInfo[index].volunteers.toString() + "/" + eventInfo[index].spots,
                    style: TextStyle(
                      fontSize: 20,
                    ),
                  ),
